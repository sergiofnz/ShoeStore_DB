...
function add_order_item($shoe_id, $order_id, $quantity, $fk_id_usuario){
    echo $shoe_id . $order_id . $quantity , $fk_id_usuario;
    global $db;
    $query = '
        INSERT INTO items_in_order (shoeID, orderID, item_quantity, fk_id_usuario)
        VALUES (:shoe_id, :order_id, :quantity, :fk_id_usuario)';
    $statement = $db->prepare($query);
    $statement->bindValue(':shoe_id', $shoe_id);
    $statement->bindValue(':order_id', $order_id);
    $statement->bindValue(':quantity', $quantity);
    //Agregamos esto
    $statement->bindValue(':fk_id_usuario', $fk_id_usuario);
    $statement->execute();
    $statement->closeCursor();
}
